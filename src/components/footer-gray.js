      ...
      <div className="footer-gray-container">
        <div className="footer-gray-container1">
          <div className="footer-gray-container2">
            <span className="footer-gray-text">MULTIVERSE</span>
            <span className="footer-gray-text01">Social</span>
            <div className="footer-gray-container3">
              <a
                href="https://www.facebook.com/FNTOKENS/"
                target="_blank"
              ...
              <a
                href="https://github.com/MULTIVERSE-C2C"
                target="_blank"
                rel="noreferrer noopener"
          ...
          <div className="footer-gray-container4">
            ...
            <div className="footer-gray-container6">
              <span className="footer-gray-text07 Large">
                Help &amp; Support
              </span>
              <a
                href="mailto:multiverse@fntokens.xyz?subject="
                className="footer-gray-link3 Large"
              >
                Contact Us
              </a>
              <span className="footer-gray-text08 Large">Knowledge Center</span>
        ...
        <span className="footer-gray-text11 Small">
          <span>All rights reserved. Copyright © 2022 multiverseC2C</span>
          <span>.</span>
        </span>
      </div>
    </footer>
